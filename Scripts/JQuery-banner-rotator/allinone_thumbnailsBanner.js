(function($) {
		...
		return this.each(function() {
			...
			imgs.each(function() {
	            ...
	            if(current_obj.currentImg.is('img')){
					...
					thumbsHolder_Thumb = jQuery('<div class="thumbsHolder_ThumbOFF" rel="'+ (total_images-1) +'"><img src="'+ options.thumbsFolder + image_name + '"></div>');
	...
	$.fn.allinone_thumbnailsBanner.defaults = {
			...
			thumbsFolder: 'images/cool/thumbs',
			showThumbs:true,
